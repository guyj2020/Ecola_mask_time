...
warm_ups = [0.1] #[0.05, 0.1, 0.2, 0.3] 
weight_decays = [0.1] #[0.01, 0.05, 0.1, 0.2] 
# weight_decays = [0.1] # default setting
train_batch_sizes = [128] # [16,128,256,512]
gpus = [0, 1 ,2, 3]
for lr in learning_rates:
    ...
    # for train_batch_size in train_batch_sizes:
        # for gpu in gpus:
            subprocess.run([
                    "python3", "run_e2e_train.py",  "--num_train_epochs", "500", \
                    "--dataset", "DuEE", "--data_dir", f"../data/DuEE/DuEE_e2e_backup_1/pretrain_data/", \
                    "--entity_dic_file", "../data/DuEE/DuEE_e2e/entities.txt", \
                    "--relation_dic_file", "../data/DuEE/DuEE_e2e/relations.txt", \
                    "--loss_lambda","0.3",  "--exp", f"hp_lr{lr}_wu{warm_up}_wd{weight_decay}", \
                    "--learning_rate", f"{lr}", \
                    "--train_batch_size", "8", \
